        ...
        {reports.map((report) => (
          ...
          >
            <div className="relative aspect-[16/9] overflow-hidden bg-[#e7f4f7]">
              ...
              <span className="absolute left-3 top-3 rounded-md bg-white px-2.5 py-1 text-xs font-semibold text-[#0B5E78] shadow-sm">
            ...
            <div className="flex flex-1 flex-col p-5">
              ...
              <a
                ...
                className="mt-5 inline-flex h-11 items-center justify-center gap-2 rounded-md bg-[#176F91] px-4 text-sm font-semibold text-white transition-colors hover:bg-[#0B5E78] focus:outline-none focus:ring-2 focus:ring-[#176F91] focus:ring-offset-2"
              >
                View report
