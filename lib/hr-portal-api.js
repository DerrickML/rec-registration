...
export async function fetchHrPortalJson(path, { method = "GET", body, bearerToken, cache = "no-store", signal, clientIp, userAgent, devSecret } = {}) {
  const headers = {
  ...
  if (devSecret) headers["X-REC-Dev-Secret"] = devSecret
