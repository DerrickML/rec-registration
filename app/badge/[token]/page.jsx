...
export default async function DigitalBadgePage({ params }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main id="main-content" tabIndex={-1} className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
          <div className="bg-[#0B5E78] px-5 py-6 text-white sm:px-8">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <div className="mb-3 inline-flex items-center gap-2 rounded-lg bg-white/10 px-3 py-1.5 text-xs font-bold uppercase tracking-normal text-white/85">
              ...
              <div className="rounded-lg border border-white/15 bg-white/10 px-4 py-3 text-sm font-semibold text-white/85">
          ...
          <div className="grid gap-0 lg:grid-cols-[360px_minmax(0,1fr)]">
            <aside className="border-b border-slate-200 bg-slate-50 p-5 lg:border-b-0 lg:border-r sm:p-8">
              <div className="rounded-lg border border-slate-200 bg-white p-4 text-center shadow-sm">
                ...
                <img
                  ...
                  className="mx-auto h-64 w-64 rounded-lg border border-slate-100 bg-white p-2"
                />
                <div className="mt-4 flex flex-col gap-2">
                  ...
                  >
                    <Button className="h-10 w-full rounded-lg bg-[#176F91] text-sm font-bold text-white hover:bg-[#0B5E78]">
              ...
              {badgeNumber && (
                <div className="mt-4 rounded-lg border border-cyan-200 bg-cyan-50 p-4 text-center">
                  <div className="mb-2 flex items-center justify-center gap-2 text-xs font-semibold uppercase tracking-normal text-[#176F91]">
                    <Hash className="h-4 w-4" />
                    Manual badge number
                  </div>
                  <div className="font-mono text-2xl font-black tracking-normal text-[#0B5E78]">{badgeNumber}</div>
            ...
            <section className="grid content-start gap-5 p-5 sm:p-8">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-lg border border-slate-200 bg-white p-4">
                  <div className="mb-2 flex items-center gap-2 text-xs font-bold uppercase tracking-normal text-slate-500">
                    <UserRound className="h-4 w-4 text-[#176F91]" />
                    Registrant
                  </div>
                  <p className="text-lg font-semibold text-slate-950">{registration.name || "Registrant"}</p>
                  ...
                  {registration.sponsorOrganization && (
                    <p className="mt-2 text-sm font-semibold text-[#176F91]">
                ...
                <div className="rounded-lg border border-slate-200 bg-white p-4">
                  <div className="mb-2 flex items-center gap-2 text-xs font-bold uppercase tracking-normal text-slate-500">
                    <ShieldCheck className="h-4 w-4 text-[#176F91]" />
                    Badge Status
                  </div>
              ...
              <div className="rounded-lg border border-slate-200 bg-white p-5">
                <h2 className="text-xl font-semibold text-slate-950">{conference.title || "Renewable Energy Conference"}</h2>
                <div className="mt-4 grid gap-3 text-sm text-slate-700 sm:grid-cols-2">
                  <div className="flex items-start gap-3">
                    <CalendarDays className="mt-0.5 h-5 w-5 text-[#176F91]" />
                    <span>{formatDateRange(conference)}</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <MapPin className="mt-0.5 h-5 w-5 text-[#176F91]" />
              ...
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-5">
                <h3 className="text-sm font-semibold uppercase tracking-normal text-slate-500">Conference attendance</h3>
                <div className="mt-3 flex flex-wrap gap-2">
                  {(registration.daysAttending || []).length ? (
                    registration.daysAttending.map((day) => (
                      <span key={day} className="rounded-lg bg-[#176F91]/10 px-3 py-1.5 text-sm font-bold text-[#176F91]">{day}</span>
                    ))
                  ) : (
              ...
              <a
                href={badge.badgeUrl}
                className="inline-flex items-center gap-2 text-sm font-bold text-[#176F91] hover:text-[#0B5E78]"
              >
