...
// Simple SVG social icons for the footer
...
export default function Footer({ conference }) {
  ...
  const parsedSocialsJson = (() => {
    if (!conference.socialsJson) return { socials: {} }
    try {
            ...
            <div className="space-y-4">
              {conference.contactEmail && (
                <a
                  ...
                  className="text-gray-400 hover:text-white text-sm flex items-center space-x-3 transition-colors group"
                >
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="text-sm text-white font-medium group-hover:text-[#FFB803] transition-colors">
                    Ministry of Energy
                  </p>
